...
for i in df.index:
   if df['City'][i] in small_cities:
      if df['Grade'][i] == 'A':
         small_A += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'B':
         small_B += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'C':
         small_C += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'D':
         small_D += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
   if df['City'][i] in medium_cities:
      if df['Grade'][i] == 'A':
         medium_A += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'B':
         medium_B += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'C':
         medium_C += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'D':
         medium_D += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
   if df['City'][i] in large_cities:
      if df['Grade'][i] == 'A':
         large_A += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'B':
         large_B += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'C':
         large_C += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
      if df['Grade'][i] == 'D':
         large_D += (round(df['PHOLC'][i] * df['Total'][i]) * [(((df['NO2'][i]) - pwms[df['City'][i]]) / pwms[df['City'][i]]) * 100])
...
ax.legend()
plt.savefig('no2-diff-city-per.png', dpi = 300)
