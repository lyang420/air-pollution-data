...
for i in df.index:
   if df['Grade'][i] == 'A':
      pm25_hispanic_A += (df['Hispanic'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_asian_A += (df['Asian'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_black_A += (df['Black'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_total_A += (df['Total'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_white_A += (df['White'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
   if df['Grade'][i] == 'B':
      pm25_hispanic_B += (df['Hispanic'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_asian_B += (df['Asian'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_black_B += (df['Black'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_total_B += (df['Total'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_white_B += (df['White'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
   if df['Grade'][i] == 'C':
      pm25_hispanic_C += (df['Hispanic'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_asian_C += (df['Asian'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_black_C += (df['Black'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_total_C += (df['Total'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_white_C += (df['White'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
   if df['Grade'][i] == 'D':
      pm25_hispanic_D += (df['Hispanic'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_asian_D += (df['Asian'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_black_D += (df['Black'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_total_D += (df['Total'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
      pm25_white_D += (df['White'][i] * [(df['PM25'][i] - pwms[df['City'][i]])])
