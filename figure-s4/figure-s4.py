...
def generate_plot(data, percentiles, title, x_label, y_label, y_min, y_max, x_tick_loc, x_ticks, y_ticks, file_name):
   fig, ax = plt.subplots()
...
generate_plot(no2_data, percentiles, 'Overall Cumulative NO₂ Distribution',
              'Population Percentile', 'NO₂ (ppb)', 0, 35, ticks, ticks, (0, 10, 20, 30),
              'figure-s4-a.png')
generate_plot(pm25_data, percentiles, 'Overall Cumulative PM₂.₅ Distribution',
              'Population Percentile', 'PM₂.₅ (μg/m³)', 0, 16, ticks, ticks, (4, 8, 12, 16),
              'figure-s4-b.png')
