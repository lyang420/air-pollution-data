...
for i in df.index:
   if df['City'][i] in small_cities:
      if df['Grade'][i] == 'A':
         small_A += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'B':
         small_B += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'C':
         small_C += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'D':
         small_D += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
   if df['City'][i] in medium_cities:
      if df['Grade'][i] == 'A':
         medium_A += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'B':
         medium_B += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'C':
         medium_C += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'D':
         medium_D += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
   if df['City'][i] in large_cities:
      if df['Grade'][i] == 'A':
         large_A += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'B':
         large_B += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'C':
         large_C += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
      if df['Grade'][i] == 'D':
         large_D += (round(df['PHOLC'][i] * df['Total'][i]) * [(df['PM25'][i]) - pwms[df['City'][i]]])
...
ax.legend()
plt.savefig('pm25-diff-city(1).png', dpi = 300)
